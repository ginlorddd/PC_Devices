...
ORDER BY JIG_TYPE_CODE;";
        ...
        public int UpsertJigTypeMaster(string JIG_TYPE_CODE, string JIG_TYPE_NAME, string JIG_TYPE_MAIN, bool IS_ACTIVE)
        {
            const string SQL_QUERY = @"
...
ELSE
BEGIN
    INSERT INTO dbo.JIG_TYPE_MASTER (JIG_TYPE_CODE, JIG_TYPE_NAME, JIG_TYPE_MAIN, IS_ACTIVE, CREATED_AT)
    VALUES (@JIG_TYPE_CODE, @JIG_TYPE_NAME, @JIG_TYPE_MAIN, @IS_ACTIVE, GETDATE())
END";
