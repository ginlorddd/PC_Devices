...
INSERT INTO @REQ(MANAGEMENT_NO, JIG_NAME, JIG_TYPE_CODE, JIG_SIZE, USE_PRODUCT, LOCATION_CODE, DEPARTMENT, CHECK_FREQUENCY)
SELECT MANAGEMENT_NO, JIG_NAME, JIG_TYPE_CODE, JIG_SIZE, USE_PRODUCT, LOCATION_CODE, DEPARTMENT, CHECK_FREQUENCY
FROM dbo.JIG_REGISTER_REQUEST
WHERE REQUEST_ID = @REQUEST_ID
  AND REQUEST_STATUS = 'WAITING_APPROVE';
...
WHEN NOT MATCHED THEN
    INSERT (CONTROL_NO, JIG_NAME, JIG_TYPE_CODE, JIG_SIZE, USE_PRODUCT, LOCATION_CODE, STATUS_USE, USE_SECTION, CHECK_FREQUENCY, IS_ACTIVE, CREATED_AT)
    VALUES (S.MANAGEMENT_NO, S.JIG_NAME, S.JIG_TYPE_CODE, S.JIG_SIZE, S.USE_PRODUCT, S.LOCATION_CODE, N'Đang sử dụng', S.DEPARTMENT, S.CHECK_FREQUENCY, 1, GETDATE());
